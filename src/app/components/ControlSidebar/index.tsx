			...
			<div className="tab-content">
				...
				<div className="tab-pane" id="control-sidebar-settings-tab">
					...
					<ul className="todo-list mt-20">
						<li className="py-15 by-1 px-5">
							<input
								type="checkbox"
								id="basic_checkbox_1"
								className="filled-in"
							/>
							<label htmlFor="basic_checkbox_1" className="h-15 mb-0"></label>
						...
						<li className="py-15 px-5">
							<input
								...
								className="filled-in"
							/>
							<label htmlFor="basic_checkbox_2" className="h-15 mb-0"></label>
						...
						<li className="py-15 by-1 px-5">
							<input
								...
								className="filled-in"
							/>
							<label htmlFor="basic_checkbox_3" className="h-15 mb-0"></label>
						...
						<li className="py-15 px-5">
							<input
								...
								className="filled-in"
							/>
							<label htmlFor="basic_checkbox_4" className="h-15 mb-0"></label>
						...
						<li className="py-15 by-1 px-5">
							<input
								...
								className="filled-in"
							/>
							<label htmlFor="basic_checkbox_5" className="h-15 mb-0"></label>
						...
						<li className="py-15 px-5">
							<input
								...
								className="filled-in"
							/>
							<label htmlFor="basic_checkbox_6" className="h-15 mb-0"></label>
						...
						<li className="py-15 by-1 px-5">
							<input
								...
								className="filled-in"
							/>
							<label htmlFor="basic_checkbox_7" className="h-15 mb-0"></label>
							<span className="text-line">Nulla vitae purus</span>
							<small className="badge bg-danger">
								<i className="fa fa-clock-o"></i> 2 mins
							</small>
						...
						<li className="py-15 px-5">
							<input
								...
								className="filled-in"
							/>
							<label htmlFor="basic_checkbox_8" className="h-15 mb-0"></label>
							<span className="text-line">Phasellus interdum</span>
							<small className="badge bg-info">
								<i className="fa fa-clock-o"></i> 4 hours
							</small>
						...
						<li className="py-15 by-1 px-5">
							<input
								...
								className="filled-in"
							/>
							<label htmlFor="basic_checkbox_9" className="h-15 mb-0"></label>
							<span className="text-line">Quisque sodales</span>
							<small className="badge bg-warning">
								<i className="fa fa-clock-o"></i> 1 day
							</small>
						...
						<li className="py-15 px-5">
							<input
								...
								className="filled-in"
							/>
							<label htmlFor="basic_checkbox_10" className="h-15 mb-0"></label>
							<span className="text-line">Proin nec mi porta</span>
							<small className="badge bg-success">
								<i className="fa fa-clock-o"></i> 3 days
							</small>
